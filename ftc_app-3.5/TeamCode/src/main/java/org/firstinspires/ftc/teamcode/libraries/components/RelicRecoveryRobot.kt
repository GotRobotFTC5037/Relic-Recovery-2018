...
import org.firstinspires.ftc.teamcode.libraries.components.attachments.JewelStick
import org.firstinspires.ftc.teamcode.libraries.components.drivetrains.MecanumDriveTrain
import org.firstinspires.ftc.teamcode.libraries.components.lift.RelicRecoveryRobotLift
import org.firstinspires.ftc.teamcode.libraries.components.sensors.RangeSensor
...
class RelicRecoveryRobot(linearOpMode: LinearOpMode): Robot(linearOpMode) {
    ...
    fun setup() {
        ...
        this.addComponent(RelicRecoveryRobotLift(linearOpMode), LIFT)
    ...
    val lift: RelicRecoveryRobotLift
        get() = lifts[LIFT] as RelicRecoveryRobotLift
    ...
    fun driveToDistanceFromObject(direction: ObjectDirection, targetDistance: Double, drivePower: Double, shouldCorrect: Boolean) {
        ...
        if (!linearOpMode.isStopRequested) {
            ...
            if (shouldCorrect) {
                ...
                val leftDistance = rangeSensor.distanceDetected
                if ((targetDistance + DEFAULT_OBJECT_DISTANCE_TOLERANCE < leftDistance
                        || targetDistance - DEFAULT_OBJECT_DISTANCE_TOLERANCE > leftDistance)
